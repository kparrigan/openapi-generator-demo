...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DeleteUserResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="status">Status message in response to the disable user action.</param>
        public DeleteUserResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string status = default(string))
        {
        ...
        */
        ...
        /// <summary>
        /// Status message in response to the disable user action
        /// </summary>
        /// <value>Status message in response to the disable user action</value>
        /*
        <example>Ok, Jane Doe has been disabled. They will no longer be able to log in.</example>
        */
