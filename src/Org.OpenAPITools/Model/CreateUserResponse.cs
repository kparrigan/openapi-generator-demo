...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateUserResponse : IValidatableObject
    {
        ...
        public CreateUserResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), CreatedUser user = default(CreatedUser))
        {
