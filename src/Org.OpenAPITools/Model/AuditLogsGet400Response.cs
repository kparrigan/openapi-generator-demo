...
{
    /// <summary>
    /// AuditLogsGet400Response
    /// </summary>
    [DataContract(Name = "_audit_logs_get_400_response")]
    public partial class AuditLogsGet400Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogsGet400Response" /> class.
        /// </summary>
        ...
        public AuditLogsGet400Response(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string message = default(string))
        {
        ...
        */
        ...
        /*
        <example>The request is missing required information</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditLogsGet400Response {\n");
