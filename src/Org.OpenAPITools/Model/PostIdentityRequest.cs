...
namespace Org.OpenAPITools.Model
{
    ...
    /// PostIdentityRequest
    /// </summary>
    [DataContract(Name = "PostIdentityRequest")]
    public partial class PostIdentityRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostIdentityRequest" /> class.
        /// </summary>
        ...
        /// <param name="extraAttributes">extraAttributes.</param>
        public PostIdentityRequest(string name = default(string), string email = default(string), DateTime? emailStartDate = default(DateTime?), DateTime? emailEndDate = default(DateTime?), string phoneNumber = default(string), DateTime? phoneNumberStartDate = default(DateTime?), DateTime? phoneNumberEndDate = default(DateTime?), string externalId = default(string), DateTime? externalIdStartDate = default(DateTime?), DateTime? externalIdEndDate = default(DateTime?), List<PostIdentityRequestExtraAttributesInner> extraAttributes = default(List<PostIdentityRequestExtraAttributesInner>))
        {
            this.Name = name;
            this.Email = email;
        ...
        */
        ...
        public List<PostIdentityRequestExtraAttributesInner> ExtraAttributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostIdentityRequest {\n");
