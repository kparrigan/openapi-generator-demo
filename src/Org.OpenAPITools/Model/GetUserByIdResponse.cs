...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GetUserByIdResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetUserByIdResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), GetUser user = default(GetUser))
        {
