...
namespace Org.OpenAPITools.Model
{
    ...
    /// PutUserByIdResponse
    /// </summary>
    [DataContract(Name = "PutUserByIdResponse")]
    public partial class PutUserByIdResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutUserByIdResponse" /> class.
        /// </summary>
        ...
        public PutUserByIdResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), GetUser user = default(GetUser))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutUserByIdResponse {\n");
