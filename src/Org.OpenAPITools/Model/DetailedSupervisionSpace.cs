...
{
    /// <summary>
    /// DetailedSupervisionSpace
    /// </summary>
    [DataContract(Name = "DetailedSupervisionSpace")]
    public partial class DetailedSupervisionSpace : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailedSupervisionSpace" /> class.
        /// </summary>
        ...
        /// <param name="compiledParticipantList">All identities associated with the supervision space, including identities from directory groups.</param>
        /// <param name="compiledUserList">All users associated with the supervision space, including user groups.</param>
        ...
        /// <param name="directoryGroups">The directory groups associated with this supervision space.</param>
        ...
        /// <param name="participants">The identities directly associated with the supervision space not including identities from directory groups.</param>
        ...
        /// <param name="userGroups">The user groups associated with this supervision space.</param>
        /// <param name="users">All users associated with the supervision space, not including user groups.</param>
        public DetailedSupervisionSpace(bool allParticipants = default(bool), bool allUsers = default(bool), bool canDelete = default(bool), bool canEnableAllParticipants = default(bool), List<SupervisionSpacesSchemasParticipant> compiledParticipantList = default(List<SupervisionSpacesSchemasParticipant>), List<User> compiledUserList = default(List<User>), DateTime createdAt = default(DateTime), string description = default(string), List<DetailedSupervisionSpaceDirectoryGroupsInner> directoryGroups = default(List<DetailedSupervisionSpaceDirectoryGroupsInner>), bool disabled = default(bool), int entryStrategiesCount = default(int), bool hardEnforce = default(bool), int id = default(int), List<IntegrationsInner> integrations = default(List<IntegrationsInner>), List<MediaTypesInner> mediaTypes = default(List<MediaTypesInner>), string name = default(string), int participantCount = default(int), List<SupervisionSpacesSchemasParticipant> participants = default(List<SupervisionSpacesSchemasParticipant>), List<RetentionLibrariesInner> retentionLibraries = default(List<RetentionLibrariesInner>), int reviewerCount = default(int), int supervisionSpacePriority = default(int), DateTime updatedAt = default(DateTime), List<DetailedSupervisionSpaceUserGroupsInner> userGroups = default(List<DetailedSupervisionSpaceUserGroupsInner>), List<User> users = default(List<User>))
        {
            this.AllParticipants = allParticipants;
            this.AllUsers = allUsers;
            this.CanDelete = canDelete;
            this.CanEnableAllParticipants = canEnableAllParticipants;
            this.CompiledParticipantList = compiledParticipantList;
            this.CompiledUserList = compiledUserList;
        ...
        */
        ...
        /// <summary>
        /// All identities associated with the supervision space, including identities from directory groups
        /// </summary>
        /// <value>All identities associated with the supervision space, including identities from directory groups</value>
        [DataMember(Name = "compiled_participant_list", EmitDefaultValue = false)]
        public List<SupervisionSpacesSchemasParticipant> CompiledParticipantList { get; set; }

        /// <summary>
        /// All users associated with the supervision space, including user groups
        /// </summary>
        /// <value>All users associated with the supervision space, including user groups</value>
        [DataMember(Name = "compiled_user_list", EmitDefaultValue = false)]
        public List<User> CompiledUserList { get; set; }
        ...
        */
        ...
        /// <summary>
        /// The directory groups associated with this supervision space
        /// </summary>
        /// <value>The directory groups associated with this supervision space</value>
        [DataMember(Name = "directory_groups", EmitDefaultValue = false)]
        public List<DetailedSupervisionSpaceDirectoryGroupsInner> DirectoryGroups { get; set; }
        ...
        */
        ...
        /// <summary>
        /// The identities directly associated with the supervision space not including identities from directory groups
        /// </summary>
        /// <value>The identities directly associated with the supervision space not including identities from directory groups</value>
        [DataMember(Name = "participants", EmitDefaultValue = false)]
        public List<SupervisionSpacesSchemasParticipant> Participants { get; set; }
        ...
        */
        ...
        /// <summary>
        /// The user groups associated with this supervision space
        /// </summary>
        /// <value>The user groups associated with this supervision space</value>
        [DataMember(Name = "user_groups", EmitDefaultValue = false)]
        public List<DetailedSupervisionSpaceUserGroupsInner> UserGroups { get; set; }

        /// <summary>
        /// All users associated with the supervision space, not including user groups
        /// </summary>
        /// <value>All users associated with the supervision space, not including user groups</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetailedSupervisionSpace {\n");
            ...
            sb.Append("  CompiledParticipantList: ").Append(CompiledParticipantList).Append("\n");
            sb.Append("  CompiledUserList: ").Append(CompiledUserList).Append("\n");
