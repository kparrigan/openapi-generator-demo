...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetIntegrationStateResponse")]
    public partial class GetIntegrationStateResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetIntegrationStateResponse" /> class.
        /// </summary>
        ...
        public GetIntegrationStateResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), GetIntegrationStateResponseState state = default(GetIntegrationStateResponseState))
        {
        ...
        */
        ...
        public GetIntegrationStateResponseState State { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetIntegrationStateResponse {\n");
