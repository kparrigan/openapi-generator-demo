...
{
    /// <summary>
    /// DirectoryGroupsIdGet404Response
    /// </summary>
    [DataContract(Name = "_directory_groups__id__get_404_response")]
    public partial class DirectoryGroupsIdGet404Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryGroupsIdGet404Response" /> class.
        /// </summary>
        ...
        public DirectoryGroupsIdGet404Response(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string message = default(string))
        {
        ...
        */
        ...
        /*
        <example>Unable to find the requested resource</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectoryGroupsIdGet404Response {\n");
