...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetMeResponse
    /// </summary>
    [DataContract(Name = "GetMeResponse")]
    public partial class GetMeResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetMeResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), MeUser user = default(MeUser))
        {
