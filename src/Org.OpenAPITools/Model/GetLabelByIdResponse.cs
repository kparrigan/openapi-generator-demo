...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetLabelByIdResponse")]
    public partial class GetLabelByIdResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLabelByIdResponse" /> class.
        /// </summary>
        ...
        public GetLabelByIdResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Label label = default(Label))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLabelByIdResponse {\n");
