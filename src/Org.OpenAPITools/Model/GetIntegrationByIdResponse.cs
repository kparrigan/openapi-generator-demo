...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetIntegrationByIdResponse")]
    public partial class GetIntegrationByIdResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetIntegrationByIdResponse" /> class.
        /// </summary>
        ...
        public GetIntegrationByIdResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Integration integration = default(Integration))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetIntegrationByIdResponse {\n");
