...
namespace Org.OpenAPITools.Model
{
    ...
    /// PostLabelResponse
    /// </summary>
    [DataContract(Name = "PostLabelResponse")]
    public partial class PostLabelResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostLabelResponse" /> class.
        /// </summary>
        ...
        public PostLabelResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Label label = default(Label))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostLabelResponse {\n");
