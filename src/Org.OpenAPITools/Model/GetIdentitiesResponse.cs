...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetIdentitiesResponse")]
    public partial class GetIdentitiesResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetIdentitiesResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Pagination paging = default(Pagination), List<GetIdentitiesResponseIdentitiesInner> identities = default(List<GetIdentitiesResponseIdentitiesInner>))
        {
