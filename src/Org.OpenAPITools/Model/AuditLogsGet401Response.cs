...
{
    /// <summary>
    /// AuditLogsGet401Response
    /// </summary>
    [DataContract(Name = "_audit_logs_get_401_response")]
    public partial class AuditLogsGet401Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogsGet401Response" /> class.
        /// </summary>
        ...
        public AuditLogsGet401Response(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string message = default(string))
        {
        ...
        */
        ...
        /*
        <example>Missing or bad JWT</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditLogsGet401Response {\n");
