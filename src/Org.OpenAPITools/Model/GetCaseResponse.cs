...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetCaseResponse
    /// </summary>
    [DataContract(Name = "GetCaseResponse")]
    public partial class GetCaseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCaseResponse" /> class.
        /// </summary>
        ...
        public GetCaseResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Case varCase = default(Case))
        {
