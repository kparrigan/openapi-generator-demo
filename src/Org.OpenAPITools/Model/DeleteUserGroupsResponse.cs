...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteUserGroupsResponse")]
    public partial class DeleteUserGroupsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteUserGroupsResponse" /> class.
        /// </summary>
        ...
        /// <param name="status">The status of the delete.</param>
        public DeleteUserGroupsResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string status = default(string))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>The status of the delete</value>
        /*
        <example>We have successfully deleted the user group Accounting.</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteUserGroupsResponse {\n");
