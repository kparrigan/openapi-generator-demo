...
{
    /// <summary>
    /// DeleteLabelFromRecordResponse
    /// </summary>
    [DataContract(Name = "DeleteLabelFromRecordResponse")]
    public partial class DeleteLabelFromRecordResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteLabelFromRecordResponse" /> class.
        /// </summary>
        ...
        public DeleteLabelFromRecordResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), PostLabelToRecordResponseStatus status = default(PostLabelToRecordResponseStatus))
        {
        ...
        */
        ...
        public PostLabelToRecordResponseStatus Status { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteLabelFromRecordResponse {\n");
