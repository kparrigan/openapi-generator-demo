...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetRolesResponse
    /// </summary>
    [DataContract(Name = "GetRolesResponse")]
    public partial class GetRolesResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="roles">An array of role objects.</param>
        public GetRolesResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), List<GetRolesResponseRolesInner> roles = default(List<GetRolesResponseRolesInner>))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>An array of role objects</value>
        [DataMember(Name = "roles", EmitDefaultValue = false)]
        public List<GetRolesResponseRolesInner> Roles { get; set; }
