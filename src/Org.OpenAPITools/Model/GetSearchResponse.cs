...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetSearchResponse
    /// </summary>
    [DataContract(Name = "GetSearchResponse")]
    public partial class GetSearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSearchResponse" /> class.
        /// </summary>
        ...
        /// <param name="searches">An array of search objects.</param>
        public GetSearchResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Pagination paging = default(Pagination), List<GetSearchResponseSearchesInner> searches = default(List<GetSearchResponseSearchesInner>))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>An array of search objects</value>
        [DataMember(Name = "searches", EmitDefaultValue = false)]
        public List<GetSearchResponseSearchesInner> Searches { get; set; }
