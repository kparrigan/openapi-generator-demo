...
{
    /// <summary>
    /// ParticipantInfosInner
    /// </summary>
    [DataContract(Name = "participant_infos_inner")]
    public partial class ParticipantInfosInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParticipantInfosInner" /> class.
        /// </summary>
        ...
        public ParticipantInfosInner(string id = default(string), string name = default(string), string firstName = default(string), string lastName = default(string), string email = default(string), string phoneNumber = default(string), string extension = default(string), string location = default(string), string deviceId = default(string), string employeeId = default(string), bool isExternal = false)
        {
            this.Id = id;
            this.Name = name;
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ParticipantInfosInner {\n");
