...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GetUsersResponse : IValidatableObject
    {
        ...
        /// <param name="users">An array of User objects.</param>
        public GetUsersResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), List<UserAll> users = default(List<UserAll>))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>An array of User objects</value>
