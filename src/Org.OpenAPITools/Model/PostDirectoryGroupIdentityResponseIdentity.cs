...
{
    /// <summary>
    /// PostDirectoryGroupIdentityResponseIdentity
    /// </summary>
    [DataContract(Name = "PostDirectoryGroupIdentityResponse_identity")]
    public partial class PostDirectoryGroupIdentityResponseIdentity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDirectoryGroupIdentityResponseIdentity" /> class.
        /// </summary>
        ...
        public PostDirectoryGroupIdentityResponseIdentity(DateTime createdAt = default(DateTime), string email = default(string), DateTime? emailEndDate = default(DateTime?), DateTime? emailStartDate = default(DateTime?), string externalId = default(string), DateTime? externalIdEndDate = default(DateTime?), DateTime? externalIdStartDate = default(DateTime?), List<ExtraAttributesInner> extraAttributes = default(List<ExtraAttributesInner>), int id = default(int), bool isSubmitter = default(bool), string name = default(string), bool participant = default(bool), string phoneNumber = default(string), DateTime? phoneNumberEndDate = default(DateTime?), DateTime? phoneNumberStartDate = default(DateTime?), string source = default(string), DateTime updatedAt = default(DateTime))
        {
        ...
        */
        ...
        public List<ExtraAttributesInner> ExtraAttributes { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostDirectoryGroupIdentityResponseIdentity {\n");
