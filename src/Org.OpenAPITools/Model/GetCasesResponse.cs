...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetCasesResponse
    /// </summary>
    [DataContract(Name = "GetCasesResponse")]
    public partial class GetCasesResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCasesResponse" /> class.
        /// </summary>
        ...
        /// <param name="cases">An array of all the cases.</param>
        public GetCasesResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Pagination paging = default(Pagination), List<Case> cases = default(List<Case>))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>An array of all the cases</value>
