...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetOrgUnitByIdResponse")]
    public partial class GetOrgUnitByIdResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrgUnitByIdResponse" /> class.
        /// </summary>
        ...
        public GetOrgUnitByIdResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), OrgUnit orgUnit = default(OrgUnit))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetOrgUnitByIdResponse {\n");
