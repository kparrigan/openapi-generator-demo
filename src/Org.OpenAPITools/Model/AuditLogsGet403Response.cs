...
{
    /// <summary>
    /// AuditLogsGet403Response
    /// </summary>
    [DataContract(Name = "_audit_logs_get_403_response")]
    public partial class AuditLogsGet403Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogsGet403Response" /> class.
        /// </summary>
        ...
        public AuditLogsGet403Response(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string message = default(string))
        {
        ...
        */
        ...
        /*
        <example>Access to this resource is forbidden, missing scope</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditLogsGet403Response {\n");
