...
{
    /// <summary>
    /// GetRetentionLibraryResponse
    /// </summary>
    [DataContract(Name = "GetRetentionLibraryResponse")]
    public partial class GetRetentionLibraryResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRetentionLibraryResponse" /> class.
        /// </summary>
        ...
        /// <param name="retentionLibraries">An array of retention library.</param>
        public GetRetentionLibraryResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), List<RetentionLibrary> retentionLibraries = default(List<RetentionLibrary>))
        {
        ...
        */
        ...
        /// <summary>
        /// An array of retention library
        /// </summary>
        /// <value>An array of retention library</value>
        [DataMember(Name = "retention_libraries", EmitDefaultValue = false)]
        public List<RetentionLibrary> RetentionLibraries { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetRetentionLibraryResponse {\n");
