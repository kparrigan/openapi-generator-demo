...
namespace Org.OpenAPITools.Model
{
    ...
    /// PostLabelRequest
    /// </summary>
    [DataContract(Name = "PostLabelRequest")]
    public partial class PostLabelRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostLabelRequest" /> class.
        /// </summary>
        ...
        public PostLabelRequest(string backgroundColor = default(string), bool hidden = default(bool), string longName = default(string), string shortName = default(string))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostLabelRequest {\n");
