...
{
    /// <summary>
    /// AuditLogsGet500Response
    /// </summary>
    [DataContract(Name = "_audit_logs_get_500_response")]
    public partial class AuditLogsGet500Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogsGet500Response" /> class.
        /// </summary>
        ...
        public AuditLogsGet500Response(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string message = default(string))
        {
        ...
        */
        ...
        /*
        <example>An internal server error has occurred, please submit a support ticket with the request ID</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditLogsGet500Response {\n");
