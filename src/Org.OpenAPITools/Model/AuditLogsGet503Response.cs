...
{
    /// <summary>
    /// AuditLogsGet503Response
    /// </summary>
    [DataContract(Name = "_audit_logs_get_503_response")]
    public partial class AuditLogsGet503Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogsGet503Response" /> class.
        /// </summary>
        ...
        public AuditLogsGet503Response(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string message = default(string))
        {
        ...
        */
        ...
        /*
        <example>An error has occurred and the route is currently unavailable</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditLogsGet503Response {\n");
