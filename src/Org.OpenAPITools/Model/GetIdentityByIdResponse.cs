...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetIdentityByIdResponse")]
    public partial class GetIdentityByIdResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetIdentityByIdResponse" /> class.
        /// </summary>
        ...
        public GetIdentityByIdResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Identity identity = default(Identity))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetIdentityByIdResponse {\n");
