...
namespace Org.OpenAPITools.Model
{
    ...
    /// PostDatumResponse
    /// </summary>
    [DataContract(Name = "PostDatumResponse")]
    public partial class PostDatumResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDatumResponse" /> class.
        /// </summary>
        ...
        public PostDatumResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), PostDatumResult result = default(PostDatumResult))
        {
        ...
        */
        ...
        public PostDatumResult Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostDatumResponse {\n");
