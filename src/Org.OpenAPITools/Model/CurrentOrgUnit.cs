...
namespace Org.OpenAPITools.Model
{
    ...
    /// CurrentOrgUnit
    /// </summary>
    [DataContract(Name = "CurrentOrgUnit")]
    public partial class CurrentOrgUnit : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentOrgUnit" /> class.
        /// </summary>
        ...
        /// <param name="varCurrentOrgUnit">varCurrentOrgUnit.</param>
        public CurrentOrgUnit(int statusCode = default(int), string statusString = default(string), string requestId = default(string), CurrentOrgUnit varCurrentOrgUnit = default(CurrentOrgUnit))
        {
            this.StatusCode = statusCode;
            this.StatusString = statusString;
            this.RequestId = requestId;
            this.VarCurrentOrgUnit = varCurrentOrgUnit;
        }
        ...
        */
        ...
        /// <summary>
        /// Gets or Sets VarCurrentOrgUnit
        /// </summary>
        [DataMember(Name = "current_org_unit", EmitDefaultValue = false)]
        public CurrentOrgUnit VarCurrentOrgUnit { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CurrentOrgUnit {\n");
            sb.Append("  StatusCode: ").Append(StatusCode).Append("\n");
            sb.Append("  StatusString: ").Append(StatusString).Append("\n");
            sb.Append("  RequestId: ").Append(RequestId).Append("\n");
            sb.Append("  VarCurrentOrgUnit: ").Append(VarCurrentOrgUnit).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
