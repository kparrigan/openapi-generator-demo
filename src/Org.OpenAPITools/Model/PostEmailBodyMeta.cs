...
namespace Org.OpenAPITools.Model
{
    ...
    /// PostEmailBodyMeta
    /// </summary>
    [DataContract(Name = "PostEmailBody_meta")]
    public partial class PostEmailBodyMeta : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostEmailBodyMeta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostEmailBodyMeta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostEmailBodyMeta" /> class.
        /// </summary>
        ...
        public PostEmailBodyMeta(DateTime createDate = default(DateTime), string customTransportType = default(string), string fileName = default(string), string identityData = default(string), Dictionary<string, string> platformAttributes = default(Dictionary<string, string>))
        {
            this.CreateDate = createDate;
            // to ensure "fileName" is required (not null)
            if (fileName == null)
            {
                throw new ArgumentNullException("fileName is a required property for PostEmailBodyMeta and cannot be null");
            }
            this.FileName = fileName;
            // to ensure "identityData" is required (not null)
            if (identityData == null)
            {
                throw new ArgumentNullException("identityData is a required property for PostEmailBodyMeta and cannot be null");
            }
        ...
        */
        ...
        /*
        <example>my-email-upload.eml</example>
        */
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostEmailBodyMeta {\n");
