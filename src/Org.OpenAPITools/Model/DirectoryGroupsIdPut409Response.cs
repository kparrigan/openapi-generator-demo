...
{
    /// <summary>
    /// DirectoryGroupsIdPut409Response
    /// </summary>
    [DataContract(Name = "_directory_groups__id__put_409_response")]
    public partial class DirectoryGroupsIdPut409Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryGroupsIdPut409Response" /> class.
        /// </summary>
        ...
        public DirectoryGroupsIdPut409Response(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string message = default(string))
        {
        ...
        */
        ...
        /*
        <example>The specified resource already exists</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectoryGroupsIdPut409Response {\n");
