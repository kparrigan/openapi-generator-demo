...
{
    /// <summary>
    /// PutDirectoryGroupIdentitiesResponseIdentitiesInner
    /// </summary>
    [DataContract(Name = "PutDirectoryGroupIdentitiesResponse_identities_inner")]
    public partial class PutDirectoryGroupIdentitiesResponseIdentitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutDirectoryGroupIdentitiesResponseIdentitiesInner" /> class.
        /// </summary>
        ...
        public PutDirectoryGroupIdentitiesResponseIdentitiesInner(DateTime createdAt = default(DateTime), string email = default(string), DateTime? emailEndDate = default(DateTime?), DateTime? emailStartDate = default(DateTime?), string externalId = default(string), DateTime? externalIdEndDate = default(DateTime?), DateTime? externalIdStartDate = default(DateTime?), int id = default(int), bool isSubmitter = default(bool), string name = default(string), bool participant = default(bool), string phoneNumber = default(string), DateTime? phoneNumberEndDate = default(DateTime?), DateTime? phoneNumberStartDate = default(DateTime?), string source = default(string), DateTime updatedAt = default(DateTime))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutDirectoryGroupIdentitiesResponseIdentitiesInner {\n");
