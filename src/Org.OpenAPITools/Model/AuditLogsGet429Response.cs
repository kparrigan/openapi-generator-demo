...
{
    /// <summary>
    /// AuditLogsGet429Response
    /// </summary>
    [DataContract(Name = "_audit_logs_get_429_response")]
    public partial class AuditLogsGet429Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogsGet429Response" /> class.
        /// </summary>
        ...
        public AuditLogsGet429Response(int statusCode = default(int), string statusString = default(string), string requestId = default(string), string message = default(string))
        {
        ...
        */
        ...
        /*
        <example>Too many requests for the route</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditLogsGet429Response {\n");
