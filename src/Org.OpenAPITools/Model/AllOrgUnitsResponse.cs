...
namespace Org.OpenAPITools.Model
{
    ...
    /// AllOrgUnitsResponse
    /// </summary>
    [DataContract(Name = "AllOrgUnitsResponse")]
    public partial class AllOrgUnitsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOrgUnitsResponse" /> class.
        /// </summary>
        ...
        /// <param name="orgUnits">orgUnits.</param>
        public AllOrgUnitsResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), List<OrgUnit> orgUnits = default(List<OrgUnit>))
        {
        ...
        */
        ...
        /// <summary>
        /// Gets or Sets OrgUnits
        /// </summary>
        [DataMember(Name = "org_units", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOrgUnitsResponse {\n");
            sb.Append("  StatusCode: ").Append(StatusCode).Append("\n");
            sb.Append("  StatusString: ").Append(StatusString).Append("\n");
            sb.Append("  RequestId: ").Append(RequestId).Append("\n");
            sb.Append("  OrgUnits: ").Append(OrgUnits).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
