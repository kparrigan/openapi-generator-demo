...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetIntegrationsResponse")]
    public partial class GetIntegrationsResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="integrations">An array of integration objects.</param>
        public GetIntegrationsResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), List<Integration> integrations = default(List<Integration>))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>An array of integration objects</value>
