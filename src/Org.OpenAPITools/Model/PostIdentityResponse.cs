...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostIdentityResponse")]
    public partial class PostIdentityResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostIdentityResponse" /> class.
        /// </summary>
        ...
        public PostIdentityResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Identity identity = default(Identity))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostIdentityResponse {\n");
