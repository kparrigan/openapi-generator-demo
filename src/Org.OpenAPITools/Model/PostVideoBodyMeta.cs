...
namespace Org.OpenAPITools.Model
{
    ...
    /// PostVideoBodyMeta
    /// </summary>
    [DataContract(Name = "PostVideoBody_meta")]
    public partial class PostVideoBodyMeta : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVideoBodyMeta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostVideoBodyMeta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostVideoBodyMeta" /> class.
        /// </summary>
        ...
        /// <param name="fileName">The filename for the video (required).</param>
        ...
        public PostVideoBodyMeta(DateTime createDate = default(DateTime), string customTransportType = default(string), string fileName = default(string), string identityData = default(string), VideoType? videoType = default(VideoType?), Dictionary<string, string> platformAttributes = default(Dictionary<string, string>), OwnerInfo owner = default(OwnerInfo), Dictionary<string, List<ParticipantInfosInner>> participants = default(Dictionary<string, List<ParticipantInfosInner>>))
        {
            this.CreateDate = createDate;
            // to ensure "fileName" is required (not null)
            if (fileName == null)
            {
                throw new ArgumentNullException("fileName is a required property for PostVideoBodyMeta and cannot be null");
            }
            this.FileName = fileName;
            // to ensure "identityData" is required (not null)
            if (identityData == null)
            {
                throw new ArgumentNullException("identityData is a required property for PostVideoBodyMeta and cannot be null");
            }
        ...
        */
        ...
        /// </summary>
        /// <value>The filename for the video</value>
        /*
        <example>my-video-upload.mp4</example>
        */
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostVideoBodyMeta {\n");
