...
{
    /// <summary>
    /// PostDocumentBodyMeta
    /// </summary>
    [DataContract(Name = "PostDocumentBody_meta")]
    public partial class PostDocumentBodyMeta : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDocumentBodyMeta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostDocumentBodyMeta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDocumentBodyMeta" /> class.
        /// </summary>
        ...
        /// <param name="fileName">The filename for the document (required).</param>
        ...
        public PostDocumentBodyMeta(DateTime createDate = default(DateTime), string customTransportType = default(string), DocumentType? documentType = default(DocumentType?), string fileName = default(string), string identityData = default(string), Dictionary<string, string> platformAttributes = default(Dictionary<string, string>), OwnerInfo owner = default(OwnerInfo), Dictionary<string, List<ParticipantInfosInner>> participants = default(Dictionary<string, List<ParticipantInfosInner>>))
        {
            this.CreateDate = createDate;
            // to ensure "fileName" is required (not null)
            if (fileName == null)
            {
                throw new ArgumentNullException("fileName is a required property for PostDocumentBodyMeta and cannot be null");
            }
            this.FileName = fileName;
            // to ensure "identityData" is required (not null)
            if (identityData == null)
            {
                throw new ArgumentNullException("identityData is a required property for PostDocumentBodyMeta and cannot be null");
            }
        ...
        */
        ...
        /// </summary>
        /// <value>The filename for the document</value>
        /*
        <example>my-document-upload.pdf</example>
        */
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostDocumentBodyMeta {\n");
