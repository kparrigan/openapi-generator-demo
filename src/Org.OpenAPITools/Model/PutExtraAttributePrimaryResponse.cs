...
{
    /// <summary>
    /// PutExtraAttributePrimaryResponse
    /// </summary>
    [DataContract(Name = "PutExtraAttributePrimaryResponse")]
    public partial class PutExtraAttributePrimaryResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutExtraAttributePrimaryResponse" /> class.
        /// </summary>
        ...
        public PutExtraAttributePrimaryResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), Identity identity = default(Identity))
        {
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutExtraAttributePrimaryResponse {\n");
