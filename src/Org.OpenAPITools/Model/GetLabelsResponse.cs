...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GetLabelsResponse : IValidatableObject
    {
        ...
        /// <param name="labels">An array of label objects.</param>
        public GetLabelsResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), List<Label> labels = default(List<Label>))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>An array of label objects</value>
