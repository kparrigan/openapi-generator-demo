...
namespace Org.OpenAPITools.Model
{
    ...
    /// MeUser
    /// </summary>
    [DataContract(Name = "MeUser")]
    public partial class MeUser : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeUser" /> class.
        /// </summary>
        ...
        /// <param name="currentOrgUnitTimezone">The default timezone for the current org unit.</param>
        ...
        /// <param name="otpRequired">Indicates if OTP is required for your user.</param>
        ...
        public MeUser(DateTime createdAt = default(DateTime), SchemasCurrentOrgUnit currentOrgUnit = default(SchemasCurrentOrgUnit), string currentOrgUnitTimezone = default(string), Customer customer = default(Customer), bool disabled = default(bool), DateTime? disabledAt = default(DateTime?), string defaultUserTimezone = default(string), string email = default(string), bool forceSso = default(bool), bool hasDatums = default(bool), bool hasMultipleWorkspaces = default(bool), int id = default(int), DateTime? lastLogin = default(DateTime?), string name = default(string), bool otpEnabled = default(bool), DateTime? otpEnabledAt = default(DateTime?), bool otpRequired = default(bool), DateTime? passwordChangedAt = default(DateTime?), bool queuePaused = default(bool), Role role = default(Role), int? searchId = default(int?), DateTime updatedAt = default(DateTime), string userInitials = default(string))
        {
            this.CreatedAt = createdAt;
            this.CurrentOrgUnit = currentOrgUnit;
            this.CurrentOrgUnitTimezone = currentOrgUnitTimezone;
        ...
        */
        ...
        /// <summary>
        /// The default timezone for the current org unit
        /// </summary>
        /// <value>The default timezone for the current org unit</value>
        /*
        <example>Etc/UTC</example>
        */
        [DataMember(Name = "current_org_unit_timezone", EmitDefaultValue = false)]
        public string CurrentOrgUnitTimezone { get; set; }
        ...
        */
        ...
        /// <summary>
        /// Indicates if OTP is required for your user
        /// </summary>
        /// <value>Indicates if OTP is required for your user</value>
        /*
        <example>false</example>
        */
        [DataMember(Name = "otp_required", EmitDefaultValue = true)]
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CurrentOrgUnitTimezone: ").Append(CurrentOrgUnitTimezone).Append("\n");
            ...
            sb.Append("  OtpRequired: ").Append(OtpRequired).Append("\n");
