...
namespace Org.OpenAPITools.Model
{
    ...
    /// QuotaResponse
    /// </summary>
    [DataContract(Name = "QuotaResponse")]
    public partial class QuotaResponse : IValidatableObject
    {
        /// <summary>
        ...
        public QuotaResponse(int statusCode = default(int), string statusString = default(string), string requestId = default(string), QuotaResponseQuota quota = default(QuotaResponseQuota))
        {
        ...
        */
        ...
        public QuotaResponseQuota Quota { get; set; }
