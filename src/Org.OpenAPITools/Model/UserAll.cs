...
namespace Org.OpenAPITools.Model
{
    ...
    /// UserAll
    /// </summary>
    [DataContract(Name = "UserAll")]
    public partial class UserAll : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAll" /> class.
        /// </summary>
        ...
        /// <param name="securityFilter">securityFilter.</param>
        ...
        public UserAll(DateTime createdAt = default(DateTime), SchemasCurrentOrgUnit currentOrgUnit = default(SchemasCurrentOrgUnit), Customer customer = default(Customer), bool disabled = default(bool), DateTime? disabledAt = default(DateTime?), string defaultUserTimezone = default(string), string email = default(string), bool forceSso = default(bool), bool hasDatums = default(bool), bool hasMultipleWorkspaces = default(bool), int id = default(int), DateTime? lastLogin = default(DateTime?), string name = default(string), bool otpEnabled = default(bool), DateTime? otpEnabledAt = default(DateTime?), DateTime? passwordChangedAt = default(DateTime?), bool queuePaused = default(bool), Role role = default(Role), SecurityFilter securityFilter = default(SecurityFilter), DateTime updatedAt = default(DateTime), string userInitials = default(string))
        {
        ...
        */
        ...
        /// <summary>
        /// Gets or Sets SecurityFilter
        /// </summary>
        [DataMember(Name = "security_filter", EmitDefaultValue = false)]
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SecurityFilter: ").Append(SecurityFilter).Append("\n");
